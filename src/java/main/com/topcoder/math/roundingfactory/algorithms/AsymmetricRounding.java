...
/**
 * <p>A concrete subclass of RoundingAlgorithm which performs the asymmetric rounding algorithm:</p>
 * <p>Asymmetric arithmetic rounding. If the digits past the accuracy digit are equals to the
 * comparison digit, round up, otherwise round to the nearest number.</p>
 * <p>The number will not be changed if it's already a rounded number.</p>
 * <p>Example:</p>
 * <p>round(1.251, 1, 5) -> 1.3</p>
 * <p>round(1.25, 1, 5) -> 1.3</p>
 * <p>round(-1.25, 1, 5) -> -1.2</p>
 ...
 * @version 1.0
 */
public class AsymmetricRounding extends RoundingAlgorithm {

    /**
     * <p>Constructs an instance of AsymmetricRounding with accuracyDigit equal to 2
     * and comparisonDigit equal to 5.</p>
     */
    public AsymmetricRounding() {
        // empty
    }

    /**
     * <p>Constructs an instance of AsymmetricRounding with accuracyDigit and comparisonDigit as specified.</p>
     *
     ...
     */
    public AsymmetricRounding(int accuracyDigit, int comparisonDigit) {
        super(accuracyDigit, comparisonDigit);
    }

    /**
     * <p>Performs the rounding.</p>
     * <p>If the digits past the accuracy digit are equals to the comparison digit, round up.
     * Otherwise round to the nearest number.</p>
     * <p>Example:</p>
     * <p>round(1.251, 1, 5) -> 1.3</p>
     * <p>round(1.25, 1, 5) -> 1.3</p>
     * <p>round(-1.25, 1, 5) -> -1.2</p>
    ...
    public String round(String number, int accuracyDigit, int comparisonDigit) {
        ...
        try {
            ...
            if (comparisonResult == 0) {
                // if comparisonDigit equals to truncation digits, round up
