...
/**
 * <p>Tests the UpAsymmetricRounding class.</p>
 *
 * @author TCSDEVELOPER
 *
 * @copyright (c) 2005, Topcoder, Inc. All Rights Reserved.
 ...
 * @version 1.0
 */
public class UpAsymmetricRoundingTests extends TestCase {
    ...
    /**
     * A UpAsymmetricRounding instance for tests.
     */
    ...
    /**
     * Tests constructor.
     * UpAsymmetricRounding(int, int).
     * The accuracy and comparison digits should be given value.
     */
    public void testUpAsymmetricRounding2() {

        algorithm = new UpAsymmetricRounding(3, 9);
     ...
     */
    public void testUpAsymmetricRounding3() {
        try {
            new UpAsymmetricRounding(-1, 9);
     ...
     */
    public void testUpAsymmetricRounding4() {
        try {
            new UpAsymmetricRounding(3, 0);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * Invalid comparison digits, IllegalArgumentException should be thrown.
     */
    public void testUpAsymmetricRounding5() {
        try {
            new UpAsymmetricRounding(3, 10);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
