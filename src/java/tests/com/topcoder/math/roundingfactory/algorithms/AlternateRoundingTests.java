...
/**
 * <p>Tests the AlternateRounding class.</p>
 *
 * @author TCSDEVELOPER
 *
 * @copyright (c) 2005, Topcoder, Inc. All Rights Reserved.
 ...
 * @version 1.0
 */
public class AlternateRoundingTests extends TestCase {
    ...
    /**
     * An AlternateRounding instance for tests.
     */
     ...
     */
    public void testAlternateRounding1() {
    ...
    /**
     * Tests constructor.
     * AlternateRounding(int, int).
     * The accuracy and comparison digits should be given value.
     */
    public void testAlternateRounding2() {

        algorithm = new AlternateRounding(3, 9);
     ...
     */
    public void testAlternateRounding3() {
        try {
            new AlternateRounding(-1, 9);
     ...
     */
    public void testAlternateRounding4() {
        try {
            new AlternateRounding(3, 0);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * Invalid comparison digits, IllegalArgumentException should be thrown.
     */
    public void testAlternateRounding5() {
        try {
            new AlternateRounding(3, 10);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
