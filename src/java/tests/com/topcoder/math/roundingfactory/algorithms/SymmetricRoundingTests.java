...
/**
 * <p>Tests the SymmetricRounding class.</p>
 *
 * @author TCSDEVELOPER
 *
 * @copyright (c) 2005, Topcoder, Inc. All Rights Reserved.
 ...
 * @version 1.0
 */
public class SymmetricRoundingTests extends TestCase {
    ...
    /**
     * A SymmetricRounding instance for tests.
     */
     ...
     */
    public void testSymmetricRounding1() {
    ...
    /**
     * Tests constructor.
     * SymmetricRounding(int, int).
     * The accuracy and comparison digits should be given value.
     */
    public void testSymmetricRounding2() {

        algorithm = new SymmetricRounding(3, 9);
     ...
     */
    public void testSymmetricRounding3() {
        try {
            new SymmetricRounding(-1, 9);
     ...
     */
    public void testSymmetricRounding4() {
        try {
            new SymmetricRounding(3, 0);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * Invalid comparison digits, IllegalArgumentException should be thrown.
     */
    public void testSymmetricRounding5() {
        try {
            new SymmetricRounding(3, 10);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
