...
/**
 * Accuracy tests for AsymmetricRounding.
 *
 * If b is greater than or equal to c, round up.  Otherwise, round down. In this section, round down means the value of
 * number is descreased, round up means the value of number is increased.The only different with the SymmetricRounding
 * is when c is equals to b
 *
 * Example:
 *  round(1.26, 1, 5) -> 1.3
 *  round(1.25, 1, 5) -> 1.3
 ...
 * @version 1.0
 */
public class AsymmetricRoundingAccuracyTest extends TestCase implements RoundingAccuracyTestConstants {
    /** The AsymmetricRounding used for testing. */
    private Algorithm rounding = null;

    /** Create a AsymmetricRounding instance.*/
    public void setUp() {
        rounding = new AsymmetricRounding();
    }
