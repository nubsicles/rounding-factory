...
/**
 * <p>
 * Accuracy tests for SymmetricRounding. If b is greater than c, round up.  If b is less than or equal to c, round
 * down.
 * </p>
 * 
 * <p>
 * In this section, round down means the value of number is descreased, round up means the value of number is
 * increased.
 * </p>
 * <pre>
 * Example: 
 ...
 * @version 1.0
 */
public class SymmetricRoundingAccuracyTest extends TestCase implements RoundingAccuracyTestConstants {
    /** The SymmetricRounding used for testing. */
    private Algorithm rounding = null;

    /** Create a SymmetricRounding instance.*/
    public void setUp() {
        rounding = new SymmetricRounding();
    }
