...
/**
 * <p>Tests the DownAsymmetricRounding class.</p>
 *
 * @author TCSDEVELOPER
 *
 * @copyright (c) 2005, Topcoder, Inc. All Rights Reserved.
 ...
 * @version 1.0
 */
public class DownAsymmetricRoundingTests extends TestCase {
    ...
    /**
     * A DownAsymmetricRounding instance for tests.
     */
    ...
    /**
     * Tests constructor.
     * DownAsymmetricRounding().
     * The accuracy and comparison digits should be default value.
     */
    public void testDownAsymmetricRounding1() {
    ...
    /**
     * Tests constructor.
     * DownAsymmetricRounding(int, int).
     * The accuracy and comparison digits should be given value.
     */
    public void testDownAsymmetricRounding2() {

        algorithm = new DownAsymmetricRounding(3, 9);
     ...
     */
    public void testDownAsymmetricRounding3() {
        try {
            new DownAsymmetricRounding(-1, 9);
     ...
     */
    public void testDownAsymmetricRounding4() {
        try {
            new DownAsymmetricRounding(3, 0);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * Invalid comparison digits, IllegalArgumentException should be thrown.
     */
    public void testDownAsymmetricRounding5() {
        try {
            new DownAsymmetricRounding(3, 10);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
