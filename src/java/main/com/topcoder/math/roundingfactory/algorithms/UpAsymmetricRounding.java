...
/**
 * <p>A concrete subclass of RoundingAlgorithm which performs the Always Round Up (Asymmetric)
 * rounding algorithm:</p>
 * <p>Asymmetrically rounds numbers fractions up. All numbers increase.
 * Same as DownSymmetricRounding for negative numbers.</p>
 ...
 * @version 1.0
 */
public class UpAsymmetricRounding extends RoundingAlgorithm {

    /**
     * <p>Constructs an instance of UpAsymmetricRounding with accuracyDigit equal to 2 and
     * comparisonDigit equal to 5.</p>
     */
    public UpAsymmetricRounding() {
        // empty
    }

    /**
     * <p>Constructs an instance of UpAsymmetricRounding with accuracyDigit and comparisonDigit as specified.</p>
     *
     ...
     */
    public UpAsymmetricRounding(int accuracyDigit, int comparisonDigit) {
        super(accuracyDigit, comparisonDigit);
    }

    /**
     * <p>Asymmetrically rounds numbers fractions up. All numbers increase.<p>
     * <p>Truncate everything after the accuracy digit, and round up,
