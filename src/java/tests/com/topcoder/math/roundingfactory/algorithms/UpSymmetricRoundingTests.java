...
/**
 * <p>Tests the UpSymmetricRounding class.</p>
 *
 * @author TCSDEVELOPER
 *
 * @copyright (c) 2005, Topcoder, Inc. All Rights Reserved.
 ...
 * @version 1.0
 */
public class UpSymmetricRoundingTests extends TestCase {
    ...
    /**
     * A UpSymmetricRounding instance for tests.
     */
     ...
     */
    public void testUpSymmetricRounding1() {
    ...
    /**
     * Tests constructor.
     * UpSymmetricRounding(int, int).
     * The accuracy and comparison digits should be given value.
     */
    public void testUpSymmetricRounding2() {

        algorithm = new UpSymmetricRounding(3, 9);
     ...
     */
    public void testUpSymmetricRounding3() {
        try {
            new UpSymmetricRounding(-1, 9);
     ...
     */
    public void testUpSymmetricRounding4() {
        try {
            new UpSymmetricRounding(3, 0);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * Invalid comparison digits, IllegalArgumentException should be thrown.
     */
    public void testUpSymmetricRounding5() {
        try {
            new UpSymmetricRounding(3, 10);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
    ...
    public void testRound7() {
        ...
        // down symmetric rounding
        assertEquals("result should be 1.12", "1.12", algorithm.round("1.12", 2, 5));
        assertEquals("result should be 1.13", "1.13", algorithm.round("1.12001", 2, 5));
        assertEquals("result should be -1.13", "-1.13", algorithm.round("-1.12001", 2, 5));
        ...
        assertEquals("result should be 0.01", "0.01", algorithm.round("0.00000001", 2, 5));
        assertEquals("result should be -0.01", "-0.01", algorithm.round("-0.00000001", 2, 5));
        ...
        assertEquals("result should be 1", "1", algorithm.round("0.01", 0, 5));
        assertEquals("result should be -1", "-1", algorithm.round("-0.6", 0, 5));
        assertEquals("result should be 1", "1", algorithm.round(".4", 0, 5));
        assertEquals("result should be 11", "11", algorithm.round("10.01", 0, 5));
    ...
    public void testRound12() {
        ...
        assertEquals("result should be 1.13", "1.13", algorithm.round("1.12001"));
        assertEquals("result should be -1.13", "-1.13", algorithm.round("-1.12001"));

        // the reslut should be "0"
        assertEquals("result should be 0.01", "0.01", algorithm.round("0.00000001"));
        assertEquals("result should be -0.01", "-0.01", algorithm.round("-0.00000001"));
    ...
    public void testRoundDouble4() {
        ...
        assertEquals("result should be 1.12", 1.13, algorithm.roundDouble(1.12001, 2, 5), DELTA);
        assertEquals("result should be -1.13", -1.13, algorithm.roundDouble(-1.12001, 2, 5), DELTA);

        // the reslut should be 0
        assertEquals("result should be 0", 0.01, algorithm.roundDouble(0.00000001, 2, 5), DELTA);
        assertEquals("result should be -0.01", -0.01, algorithm.roundDouble(-0.00000001, 2, 5), DELTA);
