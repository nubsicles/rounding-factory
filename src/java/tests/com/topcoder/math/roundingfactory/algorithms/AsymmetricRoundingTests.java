...
/**
 * <p>Tests the AsymmetricRounding class.</p>
 *
 * @author TCSDEVELOPER
 *
 * @copyright (c) 2005, Topcoder, Inc. All Rights Reserved.
 ...
 * @version 1.0
 */
public class AsymmetricRoundingTests extends TestCase {
    ...
    /**
     * An AsymmetricRounding instance for tests.
     */
     ...
     */
    public void testAsymmetricRounding1() {
    ...
    /**
     * Tests constructor.
     * AsymmetricRounding(int, int).
     * The accuracy and comparison digits should be given value.
     */
    public void testAsymmetricRounding2() {

        algorithm = new AsymmetricRounding(3, 9);
     ...
     */
    public void testAsymmetricRounding3() {
        try {
            new AsymmetricRounding(-1, 9);
     ...
     */
    public void testAsymmetricRounding4() {
        try {
            new AsymmetricRounding(3, 0);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
     ...
     * Invalid comparison digits, IllegalArgumentException should be thrown.
     */
    public void testAsymmetricRounding5() {
        try {
            new AsymmetricRounding(3, 10);
            fail("IllegalArgumentException should be thrown");
        } catch (IllegalArgumentException e) {
            // success
        }
    ...
    public void testRound7() {
        ...
        // symmetric rounding
        assertEquals("result should be 1.13", "1.13", algorithm.round("1.1251", 2, 5));
        assertEquals("result should be 1.13", "1.13", algorithm.round("1.125", 2, 5));
        assertEquals("result should be -1.12", "-1.12", algorithm.round("-1.125", 2, 5));
        assertEquals("result should be 1.12", "1.12", algorithm.round("1.1249", 2, 5));
        ...
        assertEquals("result should be 11", "11", algorithm.round("10.5", 0, 5));
    ...
    public void testRound12() {
        ...
        // symmetric rounding
        assertEquals("result should be 1.13", "1.13", algorithm.round("1.1251"));
        assertEquals("result should be 1.13", "1.13", algorithm.round("1.125"));
        assertEquals("result should be -1.12", "-1.12", algorithm.round("-1.125"));
        assertEquals("result should be 1.12", "1.12", algorithm.round("1.1249"));
    ...
    public void testRoundDouble4() {
        ...
        // symmetric rounding
        assertEquals("result should be 1.13", 1.13, algorithm.roundDouble(1.1251, 2, 5), DELTA);
        assertEquals("result should be 1.13", 1.13, algorithm.roundDouble(1.125, 2, 5), DELTA);
        assertEquals("result should be -1.12", -1.12, algorithm.roundDouble(-1.125, 2, 5), DELTA);
        assertEquals("result should be 1.12", 1.12, algorithm.roundDouble(1.1249, 2, 5), DELTA);
